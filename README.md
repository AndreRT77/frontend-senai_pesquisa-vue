...
## O que é?:
Vue.js é um [framework JavaScript](https://www.alura.com.br/artigos/angular-vs-react-vs-vue-js#frameworks-javascript) progressivo usado para criar interfaces de usuário (UI) e aplicações web SPA ([*Single Page Applications*](https://www.hipsters.tech/single-page-applications-hipsters-16/)).
